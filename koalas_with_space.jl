...
function initialize_model(;
    ...
    eucalyptus_consume_rate = 0.08, #death/consumption rate of eucalyptus
...
#all plots
 Plots.plot(adf.step, a_koalas[:,1],  label = "", title = "ABM populations from 1000 runs with K = 20, E = 10",xlab="Time step",ylabel="Number", linecolor = :red, titlefontsize = 8)
 ...
 Plots.plot!(adf.step, a_euca[:,size(a_koalas)[2]],label = "Eucalyptus", linecolor = :blue, legend = :top, legendfontsize = 6)
