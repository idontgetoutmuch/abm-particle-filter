...
#all plots
Gadfly.plot(actuals_line...,Coord.Cartesian(ymin=-0.1,ymax=763), Guide.XLabel("Day"),Guide.YLabel("Population"), Guide.Title("Plot of infected individuals overtime"), Guide.manual_color_key("Legend", ["Paths of first 1000 particles","Actual data from boarding school", "Mean data from pf", "2+ std from pf", "2- std from pf", "Median data from pf"], ["deepskyblue", "red", "blue", "black", "green", "purple"]))
